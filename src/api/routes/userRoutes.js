...
import { userTakeTaskController } from '../controllers/userTakeTaskController.js'
...
const userRoutes = app =>{
    ...
    app.post([ROUTES.user_take_task], checkKeys, validateUserUUID, userTakeTaskController)
